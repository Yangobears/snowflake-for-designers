...
export type TrackId =
  | "UX_STRATEGY_PLANNING"
  | "UX_WRITING"
  | "INFORMATION_ARCHITECTURE"
  | "USER_FLOWS"
  | "COMMUNICATION_PRESENTING"
  | "PROTOTYPING"
  | "BRANDING"
  | "UI_DESIGN"
  | "INTERACTION_DESIGN"
  ...
  | "AGILE"
  | "EMPATHY"
  | "QUALITIVATIVE_RESEARCH"
  | "QUANTITATIVE_RESEARCH"
  | "UX_LEADERSHIP";
export type Milestone = 0 | 1 | 2 | 3 | 4 | 5;

export type MilestoneMap = {
  UX_STRATEGY_PLANNING: Milestone,
  UX_WRITING: Milestone,
  INFORMATION_ARCHITECTURE: Milestone,
  USER_FLOWS: Milestone,
  COMMUNICATION_PRESENTING: Milestone,
  PROTOTYPING: Milestone,
  BRANDING: Milestone,
  UI_DESIGN: Milestone,
  INTERACTION_DESIGN: Milestone,
  WORKSHOP_FACILITATION: Milestone,
  DESIGN_THINKING: Milestone,
  AGILE: Milestone,
  EMPATHY: Milestone,
  QUALITIVATIVE_RESEARCH: Milestone,
  QUANTITATIVE_RESEARCH: Milestone,
  UX_LEADERSHIP: Milestone,
};
...
type Tracks = {|
  UX_LEADERSHIP: Track,
  UX_STRATEGY_PLANNING: Track,
  UX_WRITING: Track,
  INFORMATION_ARCHITECTURE: Track,
  USER_FLOWS: Track,
  COMMUNICATION_PRESENTING: Track,
  PROTOTYPING: Track,
  BRANDING: Track,
  UI_DESIGN: Track,
  INTERACTION_DESIGN: Track,
  WORKSHOP_FACILITATION: Track,
  DESIGN_THINKING: Track,
  AGILE: Track,
  EMPATHY: Track,
  QUALITIVATIVE_RESEARCH: Track,
  QUANTITATIVE_RESEARCH: Track,
|};

export const tracks: Tracks = {
  UX_STRATEGY_PLANNING: {
    displayName: "UX Strategy & Planning",
    category: "A",
    description:
      "Develops expertise in UX Strategy & Planning technologies, such as HTML, CSS, and JavaScript",
    milestones: [
      {
        summary:
          "Works effectively within established UX Strategy & Planning architectures, following current best practices",
        signals: [
      ...
      },
      {
        ...
        signals: [
          ...
          "Acts a caretaker for all of UX Strategy & Planning code",
        ],
        examples: [
      ...
      {
        summary:
          "Is an industry-leading expert in UX Strategy & Planning or sets strategic UX Strategy & Planning direction for an eng team",
        signals: [
          "Invents new techniques to innovate and overcome browser constraints",
          "Identifies and solved systemic problems with current architecture",
          "Defines a long-term vision for UX Strategy & Planning and ensures projects are in service of it",
        ],
        examples: [
          "Invented CSS in JS",
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          ...
          "Delivered audio uploading for UX Strategy & Planning",
  ...
  COMMUNICATION_PRESENTING: {
    displayName: "Communication and Presenting",
    category: "B",
    description:
    ...
    milestones: [
      ...
      },
      {
        ...
        signals: [
          ...
          "Chooses the appropriate tools for accurate and timely COMMUNICATION_PRESENTING",
        ],
        examples: [
      ...
      {
        summary:
          "Proactively shares information, actively solicits feedback, and facilitates COMMUNICATION_PRESENTING for multiple stakeholders",
        signals: [
          "Resolves COMMUNICATION_PRESENTING difficulties between others",
      ...
      },
      {
        ...
        signals: [
          "Defines processes for clear COMMUNICATION_PRESENTING for the entire team",
        ...
        examples: [
          ...
          "Created the COMMUNICATION_PRESENTING plan for a large organizational change",
  ...
  PROTOTYPING: {
    displayName: "Wire framing & Prototyping",
    category: "B",
    description:
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          ...
          "Audited UX Strategy & Planning performance in Chrome and proposed fixes",
        ],
      },
      {
        summary:
  ...
  UI_DESIGN: {
    displayName: "User Interface Design",
    category: "C",
    description:
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          ...
          "Defined standard channels for inter-team COMMUNICATION_PRESENTING",
        ],
      },
      {
      ...
      },
      {
        ...
        examples: [
          "Connected UX_LEADERSHIP QUALITIVATIVE_RESEARCH difficulties to focus on excellence",
      ...
      {
        summary:
          "Leads BRANDINGs to address issues stemming from hidden dynamics and company norms",
        signals: [
          "Builds programs to train leadership in desired skills",
          "Creates new structures that provide unique growth opportunities",
          "Leads planning and COMMUNICATION_PRESENTING for reorgs",
        ],
        examples: [
          "Lead efforts to increase number of UX_LEADERSHIP engineers",
  ...
  DESIGN_THINKING: {
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          "Worked with group member to address persistent COMMUNICATION_PRESENTING failures",
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          ...
          "Designed and taught UX Strategy & Planning guild curriculum",
        ],
      },
      {
        summary:
        ...
        signals: [
          "Sets incentive structures to recognise and reward AGILE",
  ...
  QUALITIVATIVE_RESEARCH: {
    displayName: "Qualitivative Research",
    category: "D",
    description:
  ...
  QUANTITATIVE_RESEARCH: {
    displayName: "Quantitative Research",
    category: "D",
    description:
      "Builds QUANTITATIVE_RESEARCH internally, gives of themself to the team, and champions and extols company values",
    milestones: [
      {
        summary:
        ...
        examples: [
          "Joined and actively participated in the UX Strategy & Planning guild",
  ...
  UX_LEADERSHIP: {
    displayName: "UX Leadership",
    category: "D",
    description:
      "Develops expertise in native UX_LEADERSHIP platform engineering, such as iOS or Android",
    milestones: [
      {
        summary:
      ...
      {
        summary:
          "Designs major new features and demonstrates a nuanced understanding of UX_LEADERSHIP platform constraints",
        signals: [
      ...
      {
        summary:
          "Is an industry-leading expert in UX_LEADERSHIP engineering or sets strategic UX_LEADERSHIP direction for an eng team",
        signals: [
